...
--
-- Host: localhost
-- Generation Time: Aug 02, 2016 at 11:47 AM
...
--
-- Table structure for table `discussions_users_pivot`
--
...
--
-- Table structure for table `events_users_pivot`
--
...
--
-- Dumping data for table `events_users_pivot`
--
...
--
-- Table structure for table `event_has_comment`
--
...
--
-- Dumping data for table `event_has_comment`
--
...
--
-- Table structure for table `event_has_users`
--
...
--
-- Table structure for table `messages_reported`
--
...
(71, 33, '2016-06-29 10:53:22', 1, 1, 'the team coucou  has invited you', 'http://ninja.dev/team/show/3'),
(72, 33, '2016-06-29 16:51:23', 1, 1, 'the team lalalalala  has invited you', 'http://ninja.dev/team/show/4'),
(73, 33, '2016-06-29 16:51:38', 1, 1, 'the team GEM TA SOEUR  has invited you', 'http://ninja.dev/team/show/2'),
(74, 33, '2016-07-01 15:20:58', 1, 1, 'the team Zobification  has invited you', 'http://ninja.dev/team/show/1'),
(75, 33, '2016-07-01 15:21:23', 1, 1, 'the team oneone  has invited you', 'http://ninja.dev/team/show/5'),
(76, 33, '2016-07-01 15:23:08', 1, 1, 'the team Majestic  has invited you', 'http://ninja.dev/team/show/9'),
(77, 33, '2016-07-01 15:23:19', 1, 1, 'the team nonnon  has invited you', 'http://ninja.dev/team/show/8'),
(78, 33, '2016-07-01 15:23:32', 1, 1, 'the team zqsd  has invited you', 'http://ninja.dev/team/show/7'),
(79, 33, '2016-07-01 15:23:42', 1, 1, 'the team azerty  has invited you', 'http://ninja.dev/team/show/6'),
(80, 33, '2016-07-26 11:18:16', 1, 1, 'Someone just joined your event, check it out !', 'http://ninja.dev/event/manage/31'),
(81, 33, '2016-07-26 11:18:53', 1, 1, 'Someone just joined your event, check it out !', 'http://ninja.dev/event/update/31'),
(82, 33, '2016-07-26 11:19:46', 1, 0, 'Someone just left your event, check it out !', 'http://ninja.dev/event/update/31'),
(83, 33, '2016-07-26 11:27:44', 1, 0, 'Someone just joined your event, check it out !', 'http://ninja.dev/event/update/31'),
(84, 26, '2016-07-26 11:32:37', 1, 0, 'The event \'.Quay54.\' has been deleted !', 'http://ninja.dev/'),
(85, 33, '2016-07-26 11:32:37', 1, 0, 'The event \'.Quay54.\' has been deleted !', 'http://ninja.dev/'),
(86, 26, '2016-07-26 11:32:45', 1, 0, 'The event \'.Quay54.\' has been deleted !', 'http://ninja.dev/'),
(87, 33, '2016-07-26 11:32:45', 1, 0, 'The event \'.Quay54.\' has been deleted !', 'http://ninja.dev/'),
(88, 26, '2016-07-26 11:32:59', 1, 0, 'The event \'.Quay54.\' has been deleted !', 'http://ninja.dev/'),
(89, 33, '2016-07-26 11:32:59', 1, 0, 'The event \'.Quay54.\' has been deleted !', 'http://ninja.dev/'),
(90, 26, '2016-07-26 11:33:22', 1, 1, 'The event Quay54 has been deleted !', 'http://ninja.dev/'),
(91, 33, '2016-07-26 11:33:22', 1, 0, 'The event Quay54 has been deleted !', 'http://ninja.dev/'),
(92, 26, '2016-07-26 11:37:23', 1, 0, 'The event Quay54 has been edited !', 'http://ninja.dev/event/update/31'),
(93, 33, '2016-07-26 11:37:23', 1, 0, 'The event Quay54 has been edited !', 'http://ninja.dev/event/update/31'),
(94, 26, '2016-07-26 11:38:12', 1, 1, 'The event Quay54 has been edited !', 'http://ninja.dev/event/update/31'),
(95, 26, '2016-07-26 11:42:10', 1, 1, 'The event Quay54 has been edited !', 'http://ninja.dev/event/list');
...
(33, 'Cherridi', 'Nicolas', 'Paris', NULL, 'nicolas.cherridi@gmail.com', 'ABxr0aR8ARW8M', '', '', 0, 'Nicoto', '0686732646', '8f1d4225b721f59967a4d338bb527c7d', '', '2016-06-28 10:13:59', '0000-00-00 00:00:00', 1, 'USA', 0, ''),
...
--
-- Table structure for table `user_has_sport_fav`
--
...
--
-- Table structure for table `user_info_sport`
--
...
--
-- Indexes for table `discussions_users_pivot`
--
...
--
-- Indexes for table `events_users_pivot`
--
...
--
-- Indexes for table `event_has_comment`
--
...
--
-- Indexes for table `messages_reported`
--
...
--
-- Indexes for table `team_has_user`
--
...
--
-- Indexes for table `user_info_sport`
--
...
--
-- AUTO_INCREMENT for table `discussions_users_pivot`
--
ALTER TABLE `discussions_users_pivot`
...
--
-- AUTO_INCREMENT for table `events_users_pivot`
--
ALTER TABLE `events_users_pivot`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
--
-- AUTO_INCREMENT for table `event_has_comment`
--
ALTER TABLE `event_has_comment`
...
ALTER TABLE `messages`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `messages_reported`
--
ALTER TABLE `messages_reported`
...
--
-- AUTO_INCREMENT for table `team_has_user`
--
ALTER TABLE `team_has_user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
-- AUTO_INCREMENT for table `user_info_sport`
--
ALTER TABLE `user_info_sport`
