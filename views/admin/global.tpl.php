<div class="row">
	...
	<div class="col-sm-6" id="hiddenUsers" style="width:50%;heigth:400px">
		...
		echo '<table>';
		echo '<tr><td>Username</td><td>Action</td></tr>';
		foreach($users as $user){
		    $user = User::findBy("id",$user['id'],"string",false);
		    
		    echo '<tr><td><a href='.WEBROOT.'user/show/'.$user[0]['id'].'>'.$user[0]['username'].'</a></td><td>';
		    echo '<a href="#" class="editUser" data-user="'.$user[0]['id'].'"">Edit</a> - <a href="#" class="deleteUser" data-user="'.$user[0]['id'].'""> Delete </a> - Advert - Bann </td></tr>';
	...
	<div class="col-sm-6" id="hiddenTeams" style="width:50%;heigth:400px">
		...
		foreach($teams as $team){
		    ...
		    echo '<a href="#" class="editTeam" data-team="'.$team[0]['id'].'"">Edit</a> - <a href="#" class="deleteTeam" data-team="'.$team[0]['id'].'""> Delete </a> - Advert - Bann </td></tr>';
