            ...
            if ($formType == "createEvent") {
                $form = [
    				...
    				"struct" => [
    					...
    					"from_date" => ["type" => "date", "placeholder" => "From date", "required" => 1, "msgerror" => "", "class" => "form-control js-time-input js-date"],
                        "from_time" => ["type" => "text", "placeholder" => "From Time", "required" => 1, "msgerror" => "", "class" => "form-control js-time-input js-time"],
                        "to_date"=>[ "type"=>"date", "class"=>"form-control js-time-input js-date", "placeholder"=>"To date", "required"=>1, "msgerror"=>"" ],
                        "to_time" => ["type" => "text", "placeholder" => "To Time", "required" => 1, "msgerror" => "", "class" => "form-control js-time-input js-time"],
                        "joignable_until" => ["type" => "date", "placeholder" => "Joignable until", "required" => 1, "msgerror" => "", "class" => "form-control js-time-input js-date"],
                        "joignable_until_time" => ["type" => "text", "placeholder" => "Joignable until time", "required" => 1, "msgerror" => "", "class" => "form-control js-time-input js-time"],
